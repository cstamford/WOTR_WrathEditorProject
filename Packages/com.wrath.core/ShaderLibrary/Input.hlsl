...
#include "Packages/com.wrath.core/ShaderLibrary/Lighting/LightData.cs.hlsl"
...
Buffer<uint> _GlobalLightIndicesBuffer;
	...
	#include "Packages/com.wrath.core/ShaderLibrary/IndirectRendering/IndirectInstanceData.cs.hlsl"
...
// ���� ������� INDIRECT_INSTANCING, ��������� INSTANCING_ON � �������������� ������� �� UnityInstancing.hlsl
#if defined(INDIRECT_INSTANCING)
    #ifdef INSTANCING_ON
        #undef INSTANCING_ON
    #endif
#endif
#include "Packages/com.wrath.core/ShaderLibrary/UnityInstancing.hlsl"
...
#include "Packages/com.wrath.core/ShaderLibrary/SpaceTransforms.hlsl"
