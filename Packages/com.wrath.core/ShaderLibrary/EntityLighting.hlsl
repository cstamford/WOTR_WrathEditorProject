#ifndef UNITY_ENTITY_LIGHTING_INCLUDED2
#define UNITY_ENTITY_LIGHTING_INCLUDED2

#include "Packages/com.wrath.core/ShaderLibrary/Common.hlsl"

#undef UNITY_COLORSPACE_GAMMA
#undef UNITY_COLORSPACE_LINEAR
#undef UNITY_LIGHTMAP_FULL_HDR
#undef UNITY_LIGHTMAP_RGBM_ENCODING
#undef UNITY_LIGHTMAP_DLDR_ENCODING

#define UNITY_LIGHTMAP_RGBM_ENCODING
#define UNITY_COLORSPACE_LINEAR
