...
// �������������� �� ������ https://www.slideshare.net/philiphammer/dissecting-the-rendering-of-the-surge
...
// �������������� ��� WS http://www.gamedev.net/topic/678043-how-to-blend-world-space-normals/?view=findpost&p=5287707
// u - detail normal
// t - base normal
// s - vertex normal
...
{
	/*// ������������� 2 ������
	// packedShadowmask - ��� 8-������ float [0...1] � ������� ���������� shadowmask (��. PackShadowmask)
	uint packedBits = UnpackByte(packedShadowmask);
	return float4((packedBits & 15u) / 15.0f, (packedBits >> 4u) / 15.0f, 1, 1);*/

	// ������������� 4 ������
	// packedShadowmask - ��� 16 ������ float [0...1] � ������� ���������� shadowmask (��. PackShadowmask)
