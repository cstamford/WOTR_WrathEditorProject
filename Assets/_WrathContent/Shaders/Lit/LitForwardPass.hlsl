...
#include "Packages/com.wrath.core/ShaderLibrary/Color.hlsl"
#include "LitInput.hlsl"
#include "Packages/com.wrath.core/ShaderLibrary/Lighting.hlsl"
#include "Packages/com.wrath.core/ShaderLibrary/GPUSkinning.hlsl"
#include "Packages/com.wrath.core/ShaderLibrary/DistortionUtils.hlsl"
#ifdef VAT_ENABLED
	#include "Packages/com.wrath.core/ShaderLibrary/VAT.hlsl"
#endif
#ifdef VERTEX_ANIMATION_ENABLED
	#include "Packages/com.wrath.core/ShaderLibrary/VertexAnimation.hlsl"
#endif
...
#endif
{
	...
	// _DistortionOffset - ������������ ������ � Particles.shader, ������� ����� ��� ��������
    _DistortionOffset = 0;
